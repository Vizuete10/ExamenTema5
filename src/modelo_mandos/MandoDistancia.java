...
/**
 * Clase abstracta que representa la base de cualquier mando a distancia del
 * catálogo de la tienda. Implementa Comparable para ordenar los mandos
...
public abstract class MandoDistancia implements Comparable<MandoDistancia> {
	 ...
	 */
	public MandoDistancia(String modelo, double precio) {
		this.modelo = modelo;
		this.precio = precio;
	...
	public String toString() {
		return modelo + " | " + precio + "€ | " + (encendido ? "Encendido" : "Apagado");
	}
